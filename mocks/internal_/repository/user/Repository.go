...
import (
	...
	user "github.com/pujidjayanto/goginboilerplate/internal/repository/user"
...
func (_m *Repository) Create(_a0 context.Context, _a1 *user.User) error {
...
func (_c *Repository_Create_Call) Run(run func(_a0 context.Context, _a1 *user.User)) *Repository_Create_Call {
...
func (_m *Repository) FindByEmail(_a0 context.Context, _a1 string) (*user.User, error) {
	ret := _m.Called(_a0, _a1)
...
//   - _a0 context.Context
//   - _a1 string
func (_e *Repository_Expecter) FindByEmail(_a0 interface{}, _a1 interface{}) *Repository_FindByEmail_Call {
	return &Repository_FindByEmail_Call{Call: _e.mock.On("FindByEmail", _a0, _a1)}
}

func (_c *Repository_FindByEmail_Call) Run(run func(_a0 context.Context, _a1 string)) *Repository_FindByEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *Repository) FindById(_a0 context.Context, _a1 uint) (*user.User, error) {
	ret := _m.Called(_a0, _a1)
...
func (_c *Repository_FindById_Call) RunAndReturn(run func(context.Context, uint) (*user.User, error)) *Repository_FindById_Call {
	_c.Call.Return(run)
	return _c
}
